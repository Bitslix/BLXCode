...
export const EndScene: React.FC = () => {
  ...
  const ctaY = interpolate(frame, [25, 45], [16, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  ...
  const tagY = interpolate(frame, [55, 75], [16, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  const creditOpacity = interpolate(frame, [85, 105], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
    ...
    <AbsoluteFill className="end-scene">
      ...
      <AbsoluteFill style={{ alignItems: "center", justifyContent: "center" }}>
        ...
        >
          ...
          >
            blxcode — sneak peek · more scenes soon
          </div>
        </div>
      </AbsoluteFill>
