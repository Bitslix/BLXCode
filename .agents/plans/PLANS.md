...
| planned | [titlebar-run-shortcut-menu/plan.md](titlebar-run-shortcut-menu/plan.md) | Echte BLXCode Plugin-Packages mit Settings-Tab, runtime Run-Command-Plugins und Titlebar-Run-Menü, das erkannte Commands in neuen Terminal-Slots startet |
