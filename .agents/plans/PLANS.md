...
| planned | [agent-settings-restructure/plan.md](agent-settings-restructure/plan.md) | Settings → Agent Tab komplett neu aufbauen nach Mockup (Personality/Provider/Models/Configuration-Cards), Monolith in Module splitten, Picker als reusable Komponenten, Theme-Token-Roundings + Icons, STT/TTS unabhängig (entkoppelt von Push-to-Talk), Auto-Save pro Sektion, WebSearch-Keys bleiben im API-Tab |
