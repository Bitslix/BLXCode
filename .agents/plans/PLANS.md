...
| pending | [agent-image-context.md](agent-image-context.md) | Attach images to BLXCode Agent context via global drag/drop and paste, show drop-zone feedback and preview dialog, send pending images once, then mark them read |
