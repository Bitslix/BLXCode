...
| planned | [heartbeat-memory-indexer/plan.md](heartbeat-memory-indexer/plan.md) | Globaler HeartBeat-Orchestrator mit plugin-ready interner Service-Registry, Settings-UI, Memory-Indexer fuer alle offenen Workspaces und Graph3D-gerechten Rules/Skills/Plans-Kategorien |
