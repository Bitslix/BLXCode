...
| planned | [multi-agent-chat-sessions/plan.md](multi-agent-chat-sessions/plan.md) | Echte parallele BLXCode Agent Chat-Sessions pro Workspace mit Chatlog-Plus-Button, Tab-Leiste, session-isoliertem Backend, i18n, Theme Tokens, Restart-Persistenz und Hintergrund-Notifications |
