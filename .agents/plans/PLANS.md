...
| active | [codewright-role/plan.md](codewright-role/plan.md) | Global Codewright Coder role with memory/web/docs workflows, subagent usage, terminal swarm, and auto-accept file-edit permission UX |
