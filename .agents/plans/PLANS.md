...
| planned | [settings-tabs-themes-refactor.md](settings-tabs-themes-refactor.md) | Settings von Modal zu Workbench-Tabs; Appearance-Tab mit ~12 Themes (Default: blxcode-dark), Suche, Dark/Light-Filter und Preview-Karten |
