...
| planned | [auto-update-github-releases.md](auto-update-github-releases.md) | Tauri Updater + GitHub latest.json; Auto-Check beim Start; Settings-Button; Leptos-Dialog mit Fortschritt und MB/s; i18n; Draft-Release manuell publish |
