...
| planned | [remote-ssh-file-git-resume.md](remote-ssh-file-git-resume.md) | Remote (SSH) File-/Git-Browsing + Session-Resume: persistenter Exec-Channel pro Connection, fs/git-Routing local-vs-remote, Git-Polling statt notify, Resume via remote Agent-Sessions; Phasen 0–3 |
