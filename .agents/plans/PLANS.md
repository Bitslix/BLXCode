...
| planned | [terminal-drag-to-split/plan.md](terminal-drag-to-split/plan.md) | Workspace Terminal Grid DnD erweitern: Center-Drop bleibt Swap, Edge-Drop verschiebt Terminals als Split-Pane mit PTY-/Session-Adoption |
