...
| active | [plan-folder-migration/plan.md](plan-folder-migration/plan.md) | Plans von flachen `.agents/plans/*.md` auf `.agents/plans/<slug>/plan.md` umstellen, inklusive async Migration, Statusbar-Fortschritt, Tools, Skills, i18n und Docs |
