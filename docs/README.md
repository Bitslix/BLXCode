...
User-facing notes for each version live in [`docs/releases/`](releases/) (for example [`v0.5.0.md`](releases/v0.5.0.md)). They power the in-app **What's new** dialog after updates and should stay non-technical. The technical changelog remains in [`CHANGELOG.md`](../CHANGELOG.md) at the repository root.
