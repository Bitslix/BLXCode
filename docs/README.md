...
User-facing notes for each version live in [`docs/releases/`](releases/) (for example [`v0.3.2.md`](releases/v0.3.2.md)). They power the in-app **What's new** dialog after updates and should stay non-technical. The technical changelog remains in [`CHANGELOG.md`](../CHANGELOG.md) at the repository root.
