...
**Latest release: [0.5.0](CHANGELOG.md#unreleased)** · [friendly notes](docs/releases/v0.3.3.md) — SSH remote workspaces and in-app file editor.
...
BLXCode is early-stage open source. The workbench, agent harness, sidebar Git, memory architecture map, and settings revamp are in active use on `main`; APIs and on-disk formats may still evolve. Current crate version: **0.5.0**.
